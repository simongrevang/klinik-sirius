...
import { metaFor, ogFor, canonicalFor, graphFor, pathFor } from './seo.js';
...
const App = ({ initialPage = 'forside' }) => {
  ...
  useEffect(() => {
    ...
    const graphEl = document.getElementById('graph-schema');
    if (graphEl) graphEl.textContent = JSON.stringify(graphFor(activePage));
  }, [activePage]);
